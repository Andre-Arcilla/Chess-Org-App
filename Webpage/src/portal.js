...
// ------------------------------------------------------------------
// Password Visibility Toggles (Vanilla JS adaptation of Lucide icons)
// ------------------------------------------------------------------
const iconEye = `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>`;
...
function setupPasswordToggle(toggleBtn, inputField) {
    ...
    toggleBtn.addEventListener('click', () => {
        ...
        toggleBtn.innerHTML = isPassword ? iconEyeOff : iconEye;
    });
}
